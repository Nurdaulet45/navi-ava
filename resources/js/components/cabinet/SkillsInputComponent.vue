<template>
    <div>
    <input type="text" v-model="skill_item" class="form-control input-default mt-8 w-100" @keypress.enter.prevent="addSkillItem" placeholder="Ваши навыки">
    <div class="skill-items" v-if="skills.length">
        ...
        <div class="form-custom" v-for="(skill_item, index) in skills">
            <label class="skill-item m-0" :for="index">
                {{ skill_item }}
                <svg @click.prevent="deleteSkillItem(index)" width="11" height="11" viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
