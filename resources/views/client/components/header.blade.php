...
<header class="header">
    <div class="container">
        <div class="header-body">
            ...
            <div class="end">
                <div class="menu-items">
                    <a href="{{ route('aboutService') }}" class="menu-item">
                        О сервисе
                    </a>
                    <a href="{{ route('blog') }}" class="menu-item">
                        Блог
                    </a>
...
{{--                               class="dropdown-item-not-icon active ">--}}
                            ...
                            <div class="line"></div>
                            <a class="dropdown-item-not-icon " href="{{ route('serviceRules') }}">
                                Правила сервиса
                            </a>
                            <div class="line"></div>
                            <a class="dropdown-item-not-icon " href="{{ route('termsUse') }}">
                                Пользовательское соглашение
                            </a>
                            <div class="line"></div>
                            <a class="dropdown-item-not-icon " href="{{ route('privacyPolicy') }}">
