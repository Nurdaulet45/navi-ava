<div class="modal fade" id="updateParentReviewPopup" tabindex="-1" role="dialog" aria-labelledby="updateParentReviewPopup"
     aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered " role="document">
        <div class="modal-content inner-modal">
            ...
            <div class="modal-body">
                <form id="updateParentReviewForm" class="modal-form">
                    @csrf
                    <div class="review-write">
                        ...
                        <div class="review-write-body">
                            ...
                            <textarea id="update-parent-star-text" name="review-message" rows="10" placeholder="Напишите что-нибудь"
                                      class="review-write-textarea" required></textarea>

                            <input id="update-parent-star-rating" name="star-rating" class="rating star-rating"
                                   data-min="0" data-max="5" data-step="0.1"
                                   value="0" hidden>
                        </div>
                        <input type="hidden" id="update-parent-review-id" name="review-id" value="">
                        <div class="line"></div>
                    </div>
