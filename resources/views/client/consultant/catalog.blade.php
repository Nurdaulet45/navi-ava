                    ...
                    <div class="search-result__item-cards">
                        @if($consultants)
                            @foreach($consultants as $consultant)
                                <a href="{{ route('mentors.mentor',['id'=>$consultant->id]) }}">
                                    <div class="mentor-info-card">
                                        <div class="left">
                                            <img src="{{ asset($consultant->user->avatarImage) }}" width="92px"
                                                 data-widget="92px"
                                                 alt="user icon">
                                            <div class="rate">
                                                4.5
                                        ...
                                        <div class="right">
                                            <div class="mentor-block-user-name">
                                                <p class="name">
                                                    {{ $consultant->user->firstNameAndLetterLastNameCustom }}
                                                    ,<span> {{ $consultant->user->login }}</span>
                                                </p>
                                                @if(Cache::has('is_online' . $consultant->id))
                                                    <div class="online">
                                                        <span></span> В сети
                                                    </div>
                                                @else
                                            ...
                                            <div class="work">
                                                {{ $consultant->specialization_text ?: '' }}
                                            </div>
                                            <div class="city">
                                                {{ $consultant->user->countryAddressCustom }}
                                            </div>
                                            <div class="work-info">
                                                <div class="activity">
                                                ...
                                                <div class="skills">
                                                    ...
                                                    <div class="skill-items">
                                                        @foreach(json_decode($consultant->skills) as $skill)
                                            ...
                                            <div class="actions">
                                                <div class="buttons">
                                                    <a href="{{ route('consultants.consultant',['id'=>$consultant->id]) }}"
